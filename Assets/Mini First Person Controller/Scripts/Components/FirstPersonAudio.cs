...
public class FirstPersonAudio : MonoBehaviour
{
    ...
    public void Update()
    {
        stepAudio.volume = soundManager.SoundSfx;
        runningAudio.volume = soundManager.SoundSfx;
        landingAudio.volume = soundManager.SoundSfx;
        jumpAudio.volume = soundManager.SoundSfx;
        crouchStartAudio.volume = soundManager.SoundSfx;
        crouchedAudio.volume = soundManager.SoundSfx * 0.3f;
        crouchEndAudio.volume = soundManager.SoundSfx;
    ...
    void FixedUpdate()
    {
        ...
        if (velocity >= velocityThreshold && groundCheck && groundCheck.isGrounded && Time.timeScale == 1)
        {
